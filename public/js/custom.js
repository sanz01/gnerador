...
$(document).ready(function(){
	$('.site_title').mouseover(function() {
		$('.icon-activalab').attr("src", "./assets/icon2.svg");
	});

	$('.site_title').mouseleave(function() {
		$('.icon-activalab').attr("src", "./assets/icon.svg");
	});

	$('#menu_toggle').click(function(){

		if ($('#angle').attr('data-state')=='0') {
			$('#angle').attr('data-state', '1');
			$('#angle').attr('class', 'fa fa-angle-double-right');
